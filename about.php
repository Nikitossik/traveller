...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
  ...
  <div class="hero-wrap banner about-banner pb-3">
      ...
      <div class="container pb-3">
        <div class="row tours-banner__content no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-9 ftco-animate text-center">
            <p class="breadcrumbs" data-scrollax="properties: { translateX: '-30%', opacity: 1.6 }"><span class="mr-2"><a href="index.php">Home</a></span> <span>About</span></p>
            <h1 class="mb-3 bread" data-scrollax="properties: { translateX: '30%', opacity: 1.6 }">About</h1>
          </div>
        </div>
      </div>
    </div>
